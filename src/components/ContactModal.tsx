...
export default function ContactModal({ isOpen, onClose, creator }: ContactModalProps) {
  useEffect(() => {
  ...
  const hasContacts = hasTelegram || hasInstagram;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-center text-gray-600 mb-6">{creator.name}</p>
        ...
        {hasContacts ? (
          <div className="space-y-3">
            {hasTelegram && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-[#0088cc]">{creator.telegram}</p>
                </div>
            ...
            {hasInstagram && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 p-4 bg-[#E4405F]/10 hover:bg-[#E4405F]/20 rounded-xl transition-colors"
              >
                <div className="w-10 h-10 bg-gradient-to-br from-[#833AB4] via-[#E4405F] to-[#FCAF45] rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#E4405F]">{creator.instagram}</p>
                </div>
                <svg className="w-5 h-5 text-gray-400 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                </svg>
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-500">Креатор пока не добавил контакты</p>
          </div>
        )}
      </div>
    </div>
